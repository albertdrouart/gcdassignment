...
\emini
\bminitwo
```{r 'Var-82-angle(tBodyAccMean,gravity)', echo=FALSE, fig.width=4, fig.height=3, message=FALSE, warning=FALSE}
ggAggHist(data = structure(list(xmin = c(-0.2, -0.15, -0.1, -0.05, 
...
\emini
\bminitwo
```{r 'Var-83-angle(tBodyAccJerkMean),gravityMean)', echo=FALSE, fig.width=4, fig.height=3, message=FALSE, warning=FALSE}
ggAggHist(data = structure(list(xmin = c(-0.15, -0.1, -0.05, 
...
\emini
\bminitwo
```{r 'Var-84-angle(tBodyGyroMean,gravityMean)', echo=FALSE, fig.width=4, fig.height=3, message=FALSE, warning=FALSE}
ggAggHist(data = structure(list(xmin = c(-0.4, -0.3, -0.2, -0.1, 
0, 0.1, 0.2, 0.3, 0.4), xmax = c(-0.3, -0.2, -0.1, 0, 0.1, 0.2, 
...
\emini
\bminitwo
```{r 'Var-85-angle(tBodyGyroJerkMean,gravityMean)', echo=FALSE, fig.width=4, fig.height=3, message=FALSE, warning=FALSE}
ggAggHist(data = structure(list(xmin = c(-0.25, -0.2, -0.15, 
-0.1, -0.05, 0, 0.05, 0.1, 0.15), xmax = c(-0.2, -0.15, -0.1, 
-0.05, 0, 0.05, 0.1, 0.15, 0.2), ymin = c(0, 0, 0, 0, 0, 0, 0, 
 ...
 *  Created by: Albert Drouart (username: `adrouart`).

 *  Report creation time: Thu Nov 05 2020 23:08:15

 *  Report was run from directory: `/Users/adrouart/Documents/Data Science - Coursera/gcdassignment`
 ...
 *  Function call: `dataMaid::makeDataReport(data = summary_final_data, mode = c("summarize", 
"visualize", "check"), smartNum = FALSE, file = "codebook_summary_final_data.Rmd", 
    ...
    listChecks = FALSE, maxProbVals = Inf, codebook = TRUE, reportTitle = "Codebook for summary_final_data")`
